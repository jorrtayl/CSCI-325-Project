        ...
        private void Reset()
        {
            ...
            Events = new[]
            {
                  ...
                  new Event() //Boss Test
                {
                    ...
                    Answersb1 = new[]{"Please enter answer to the right and click check, First letter should be capitalized, and clear all text in the box before typing."},
                    ...
                    Answersb5 = new[]{"Please enter answer to the right and click check, All first letters should be capitalized, and clear all text in the box before typing"},
                    ...
                    Answersb9 = new[]{"Please enter answer to the right and click check, and clear all text in the box before typing"},
